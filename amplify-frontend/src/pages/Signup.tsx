    ...
    <div className="w-[100vw] min-h-screen flex items-center justify-center bg-gray-900">
      <div className="bg-gray-800 p-8 rounded-lg shadow-xl max-w-md w-full">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">Join Amplify</h1>
          <p className="text-gray-400 text-center">Create an account to sync your music across all devices</p>
        </div>
