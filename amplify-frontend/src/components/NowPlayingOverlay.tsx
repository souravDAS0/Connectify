...
const NowPlayingOverlay: React.FC<NowPlayingOverlayProps> = ({ isOpen, onClose }) => {
    const {
        currentTrack,
        isPlaying,
        setIsPlaying,
    ...
    return (
        <div
            className={`hidden md:flex fixed inset-x-0 bottom-24 top-0 bg-gradient-to-b from-gray-800 to-gray-900 z-40 transition-transform duration-300 ease-out ${isAnimating ? 'translate-y-0' : 'translate-y-full'
                }`}
        >
